        ...
        <div className='about max-w-[1840px] w-full h-auto container'>
            <div className="about-in relative bg-[#1A1A1A] rounded-[20px] p-3 mt-5 min-[420px]:p-5 sm:pt-8 2xl:pl-8">
                ...
                <a target='_blank' href='https://t.me/xusanovvm' className='flex flex-row text-[#FF6600] gap-2 md:pt-2'>
                    <i className="fa-solid fa-circle-chevron-right text-4xl mb-4 border-2 border-[#FF6600] p-2 rounded-full xl:text-5xl"></i>
                    <p className='font-normal text-2xl uppercase mt-3 xl:text-3xl'>Start a Project</p>
                </a>
                <img
